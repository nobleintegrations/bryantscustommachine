...
<div id="home" class="w-full bg-white mx-auto container shadow-2xl">
    <header class="bg-white text-center sticky top-0 border-b-2 border-gray-300 lg:pb-6 lg:pt-24">
        <div class="logo lg:-m-20 flex justify-center"><a href="#home"><img class="text-center" style="width:16rem;"
                    src="/assets/images/logo.png" alt="Bryants Custom Machine"></a></div>
        <scrollactive active-class="active" :offset="135" class="flex my-nav text-center justify-center mb-2 lg:px-4">
            <div
                ...
                <a href="#home"
                    class="scrollactive-item no-underline px-4 py-2 mr-2 rounded hover:bg-customGreen hover:text-white hover:border-customGreen lg:p-4">Home</a>
                <a href="#services"
                    class="scrollactive-item no-underline px-4 py-2 mr-2 rounded hover:bg-customGreen hover:text-white hover:border-customGreen lg:ml-4 lg:p-4 xl:ml-12">Services</a>
            </div>
            <div
                class="nav-right flex flex-row no-underline font-medium tracking-wide md:text-xl lg:justify-end lg:flex-1 xl:mr-8">
                <a href="#about"
                    class="scrollactive-item no-underline px-4 py-2 mr-2 rounded hover:bg-customGreen hover:text-white hover:border-customGreen lg:p-4 lg:mr-4 xl:mr-12">About</a>
                <a href="#contact"
                    class="scrollactive-item no-underline px-4 py-2 rounded hover:bg-customGreen hover:text-white hover:border-customGreen lg:p-4">Contact</a>
            </div>
        </scrollactive>
    </header>
    <section class="flex flex-col hero text-center justify-center">
        ...
        <div>
            <button class="bg-white text-black px-8 py-4 rounded hover:bg-black hover:text-white"><a
                    href="tel:806-470-8511">(806) 470-8511</a></button>
        </div>
    </section>
    ...
    <div id="services" class="flex flex-col bg-white container px-4 py-12 justify-between md:flex-row">
        <div class="bg-gray-200 p-8 mb-4 md:w-1/3 md:mr-4">
            <h3 class="text-left md:text-right font-light text-xl uppercase tracking-wide not-sr-only"><span
                    class="font-bold">Our</span> Services</h3>
            <hr class="ml-0 md:ml-auto md:mr-0 border-t-2 border-customGreenDarker w-12 pb-4">
            <p class="text-left md:text-right leading-loose text-base text-gray-800">As a family owned and operated
                business, we strive to put our customers’ needs first. We stand behind our product 100%
                and guarantee each part received will be of highest quality and within the industries specifications.
            </p>
        </div>
        <div class="mb-4 overflow-hidden md:w-1/3 md:mr-4">
            <img src="https://res.cloudinary.com/noble-integrations/image/upload/v1583944171/BCM/service2_fpzoox.jpg"
            ...
            <div class="py-4">
                ...
                <p class="text-sm text-gray-800 leading-normal">At Bryants Custom Machine, we currently manufacture the
                    inner column for turbine pump applications with plans to produce
                    outer column in the near future. Our assemblies can be threaded to any of the leading manufacturers
                    specifications.</p>
            </div>
        </div>
        <div class="overflow-hidden mb-2 md:w-1/3">
            ...
            <div class="py-4">
                <div class="font-bold text-l mb-2 text-customGreenDarker uppercase tracking-wide">Water Well</div>
                <p class="text-sm text-gray-800 leading-normal">We handle a wide variety of parts used in the water well
                    industry including shaft couplings, pipe couplings, bearings,
                    jump bearings, reducer bushings, surge control valves and much more.</p>
    ...
    <div class="flex flex-col md:flex-row px-4 py-12 bg-gray-200">
        <div class="flex-1 p-4 text-center">
            ...
            <div class="mt-4 text-gray-800 leading-loose">We are bringing innovative techniques to the industry by
                designing
                and building custom equipment to elevate production.
                With the equipment and machines that are in place, we will be able to compete with the leading
                manufactures
                in todays
                market.</div>
        </div>
        <div class="flex-1 p-4 text-center">
            ...
            <div class="mt-4 text-gray-800 leading-loose">We have seven (7) CNC Machines that have been precisely
                calibrated to produce a consistent and flawless product. We use precision instruments that are
                calibrated daily to measure each product.</div>
        </div>
        <div class="flex-1 p-4 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                class="fill-current h-16 w-16 text-customGreenDarker bg-white inline-block text-center rounded-full p-4 mb-4">
    ...
    <div id="about" class="flex flex-col px-4 py-12 justify-between md:flex-row">
        <div class="flex-grow bg-cover p-8 mb-4 h-64 md:mr-6 md:w-1/2 md:mb-0 md:h-auto"
        ...
        <div class="flex-1 bg-gray-200 p-8 md:w-1/2">
            <h3 class="text-left pb-4 font-light text-xl uppercase tracking-wide"><span
                    class="font-bold border-b-2 pb-2 border-customGreen">About</span> Us</h3>
            <p class="text-left leading-loose text-gray-800 text-base">
                Established in 2018, Bryants Custom Machine is located in Littlefield, TX. A family owned and operated
                business with more than 40 Years of experience in the water well industry.<br><br>Our mission is to
    ...
    <div class="bg-gray-800 container text-gray-400 text-xl text-center px-4 py-8 md:p-12 md:text-2xl">
        Need a custom part built for your business? Give us a <a href="tel:806-470-8511"
            class="border-b-2 border-customGreen hover:border-gray-400">call</a> today.
    </div>
    <div id="contact" class="bg-white text-center">
        <div class="text-xl uppercase font-light p-8"><span class="font-bold">Our</span> <span
                class="border-b-2 border-customGreen">Loc</span>ation</div>
        <div class="w-full">
            <iframe
    ...
    <footer>
        <div class="flex flex-col bg-gray-900 text-white container px-4 py-8 md:flex-row">
            <div class="flex flex-col w-full font-light md:flex-1 md:max-w-sm">
                ...
                <div class="text-gray-400 leading-normal md:px-4">
                    <div class="pb-6">
                        <a class="hover:underline" target="_blank" href="https://goo.gl/maps/6UBkwNQ49frvRzrb9">Bryants Custom Machine<br>
                        705 E. 4th St.<br>
        ...
        <div
            ...
            <div class="text-xs text-gray-300 md:text-sm">Powered by <a
                    class="no-underline text-gray-300 hover:text-black md:text-sm" target="_blank"
                    href="https://nobleintegrationsllc.com">Noble Integrations LLC</a></div>
        </div>
    </footer>
</div>
@endsection
