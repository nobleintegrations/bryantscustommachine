...
@section('body')
    <div id="home" class="lg:w-4/5 w-full bg-white mx-auto container">
        ...
        <div class="flex flex-col hero text-center justify-center">
            ...
            <div>
                <button class="bg-white text-black px-8 py-4 rounded hover:bg-green-dark hover:text-white">(806) 385-3738</button>
            </div>
        </div>
        <div id="services" class="flex flex-col bg-white container px-8 pt-8 justify-between md:flex-row">
            ...
            <div class="mb-4 overflow-hidden md:w-1/3 md:mr-4">
                ...
                <div class="py-4">
                    <div class="font-bold text-l mb-2 text-green uppercase">Threaded Pipe</div>
